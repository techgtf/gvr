...
const Developers = () => {
  ...
  const loadDevelopers = async (search = "") => {
    ...
    const response = await Request(
      `admin/developer?search=${search}&page=${currentPage}`,
      "GET"
    );
  ...
  const toggleSwitch = async (e) => {
    try {
      ...
      const response = await Request(
        `admin/developer/${changeId}/is-popular`,
        "POST",
        formData
      );
        ...
        <table className="mt_40 w-full border-collapse">
          ...
          <tbody>
            ...
            {!isLoading && data.length ? (
                ...
                <tr key={item.id}>
                  ...
                  <td>
                    <CustomSwitch
                      ...
                      isChecked={item.is_popular}
                    />
                  </td>
                  <td>
                    <button
                      className="btn action_btn"
                      onClick={() => editDeveloperHandler(item.id)}
                    >
                      <img
                    ...
                    <button
                      className="btn action_btn"
                      onClick={() => deleteDeveloperHandler(item.id)}
                    >
                      <img
              ...
              <tr>
                <td colSpan="5">
                  <h5 className="no_record">No Developers Found!</h5>
                </td>
              </tr>
            ) : null}
          </tbody>
        ...
        <>
          <SidebarPortal className="portal">
            <SideModal
              ...
              onSubmit={
                isEnableEdit ? updateDeveloperHandler : addSubmitHandler
              }
            ...
            >
              <form>
                <div className="mb_15">
                  ...
                  />
                  {errors.developer && (
                    <div className="errMsg">{errors.developer}</div>
                  )}
                </div>
                <div className="mb_15">
                ...
                <div className="mb_15">
                  ...
                  {developerImageShow && (
                    <img width="100" src={developerImageShow} />
                  )}
                </div>
                <div className="mb_15">
                  ...
                  <textarea
                    ...
                    className="form-control textarea_sm"
                    rows="5"

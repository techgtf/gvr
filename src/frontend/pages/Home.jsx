...
const Testimonial = lazy(() =>
  import("../components/testimonialSection/testimonial")
);
const MediaCoverage = lazy(() =>
  import("../components/MediaCoverage/MediaCoverage")
);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Great Value realty, Great Value Sharanam Noida, Great Value Anandam Noida, Sector 107 Noida,  Great Value Anandam, Great Value Sharanam Sector 107 Noida, Best Casa Uday Delhi, Great Value Realty Vilasa, Best Sanctuary residential project sector 105 "
        />
        <meta
          name="description"
          content="Great Value Realty brings you luxurious & affordable homes in NCR, Noida & Gurugram. Experience unmatched quality & trust in real estate."
        />
        <meta
        ...
        <meta
          ...
          content="At Great Value Realty, we go beyond building homes—we build trust, deliver exceptional value, and create lasting experiences."
        />
        ...
        <script type="application/ld+json" className="schemantra">
          {JSON.stringify({
            ...
            image:
              "https://greatvaluerealty.com/assets/frontend/images/logo.png",
      ...
      <div className="homepage">
        ...
        <OverviewSection
          ...
          tag="h1"
        />
        <Projects heading={ourProjects.heading} apiName="getCategory" />
        <Verticals heading={ourVerticals.heading} />
        <Testimonial heading={homeTestimonials.heading} />
        <MediaCoverage heading={homeMedia.heading} />
        <BlogSection heading={homeBlogs.heading} />
      </div>
    </>
  );
}

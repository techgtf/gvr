...
export default function Residential() {
  const { data: bannerData, loading: bannerLoading } =
    useFetchData("page-sections/17");

  const {
    data: detailPageData,
    loading,
    error,
  } = useFetchData("project?category=residentials");
  const projectsData = detailPageData;

  if (bannerLoading) {
    return (
      <div className="w-full min-h-[60vh] bg-gray-200 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 animate-shimmer rounded-md"></div>
    );
  }
  if (!bannerData) {
  ...
  return (
    <>
      <Helmet>
        <title>
          Great Value Realty Residential Projects | Luxury & Affordable Homes
        </title>
        <meta
          name="keywords"
          content="Great Value Realty residential projects, luxury homes, affordable homes, modern living, real estate properties, premium residences"
        />
        <meta
          name="description"
          content="Discover Realty Residential Projects. Explore luxury and affordable homes designed for comfort, elegance, and modern living. Find your dream home today!"
        />
        <meta
        ...
        <meta
          name="author"
          content="Great Value Realty Residential Projects | Luxury & Affordable Homes"
        />
        ...
        <meta
          ...
          content="Discover Great Value Realty Residential Projects. Explore luxury and affordable homes designed for comfort, elegance, and modern living. Find your dream home today!"
        />
        <meta
          property="og:url"
          content="https://greatvaluerealty.com/residential"
        />

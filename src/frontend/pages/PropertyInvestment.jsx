    ...
    <section className="bg-[#EFF5FA]">
      ...
      <div className="flex xl:mt-[4rem] mt-[2rem] flex-wrap justify-between items-center max-w-[90%] xl:max-w-[85%] mx-auto my-0">
        <div className=" xl:basis-[45%] basis-[100%]">
          ...
          <p className="text-[#666] text-justify">
            ...
            2029, reflecting a compound annual growth rate (CAGR) of 2.46% from
            2025 to 2029..
          </p>
        </div>
        <img
      ...
      <div className="flex xl:mt-[4rem] mb-[37px] mt-[2rem] justify-between items-center max-w-[90%] flex-wrap xl:max-w-[85%] mx-auto my-0">
        <div className="xl:basis-[45%] basis-[100%]">
          ...
          <p className="text-[#666] text-justify">
            Noida has experienced a substantial increase in housing prices. Data
            from Anarock indicates that average housing prices along the Noida
            Expressway rose by 66% over the past five years, reaching Rs 8,400
            per square foot as of September 2024. This surge is attributed to
            enhanced connectivity and the establishment of commercial hubs in
            the vicinity.
          </p>
        </div>
        <img
      ...
      <div className="flex xl:mt-[4rem] mb-[37px] xl:flex-row flex-col-reverse  mt-[2rem] justify-between items-center max-w-[90%] xl:max-w-[85%] mx-auto my-0 flex-wrap">
        ...
        <div className="xl:basis-[45%] basis-[100%]">
          ...
          <p className="text-[#666] text-justify">
            The luxury housing segment in Noida has seen remarkable growth. For
            instance, Sector 150 witnessed a 12% year-on-year increase in
      ...
      <div className="flex xl:mt-[4rem] mt-[2rem] justify-between items-center max-w-[90%] xl:max-w-[85%] mx-auto my-0 flex-wrap">
        <div className="xl:basis-[45%] basis-[100%]">
          ...
          <p className="text-[#666] text-justify">
            ...
            Noida International Airport and the expansion of metro connectivity,
            have significantly bolstered Noida's real estate appeal. These
            developments are anticipated to further drive property values and

        ...
        <SlideIn duration={2} delay={0.5}>
          ...
          >
            <CommonPera
              ...
              PeraText={
                "The genesis of Great Value Industries dates to 1970, when the group set up its glassware division. In 1990, GVIL diversified into supplying quality packaging products to prestigious clients, including Home Foil, Hello Mineral Water & UB Group among many others. Plastics and packaging with a unit at Bangalore further expanded with units at Firozabad and Noida. The group envisions creating highly lucrative residential properties for sale in Noida. Have your own luxury homes with world-class, fully furnished facilities in 2, 3 and 4 BHK apartments. The year 2001 witnessed the group’s remarkable expansion in the Food Division. Group processed food domain with a 60,000 metric ton unit at Noida that was further strengthened by another 1, 80,000-metric ton unit 2 years later. Today, GVIL is a major global force with one of the world’s largest capacities in producing ready-to-eat foods. Another significant stride taken in 2001 was GVIL’s foray into IT services."
              }
            />
          </div>
        </SlideIn>

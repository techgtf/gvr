                ...
                <ul className="w-full flex flex-col gap-10">
                    <li>
                        ...
                        <div className="title_links flex justify-evenly uppercase text-[#0e69ae] py-3 ">
                            <Link className="text-[14px] tracking-[2px] cursor-pointer">about us </Link>/ 
                            <Link className="text-[14px] tracking-[2px] cursor-pointer">csr</Link> / 
                    ...
                    <li>
                        ...
                        <div className="title_links uppercase text-[#0e69ae] py-3 ">
                            <Link className="text-[14px] tracking-[2px] cursor-pointer">contact us </Link>
                        </div>
                    </li>
                </ul>
            </div>

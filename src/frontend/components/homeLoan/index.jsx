        ...
        <div className='area_converter_in lg:py-[80px] py-[20px] uppercase'>
            <div className='wrap_div lg:max-w-[95%] lg:px-0 px-[15px] w-full m-auto lg:mb-[70px] mb-[20px]'>
                <div className='grid_div grid lg:grid-cols-2'>
                    <div className='left_side grid lg:gap-[30px] gap-[15px]'>
                    ...
                    <div className='right_side'>
                        <div className='div_in lg:px-[40px] lg:py-[40px] bg-white'>
                            <div className='logo_box'>
                                <img src={`${CONFIG.ASSET_IMAGE_URL}frontend/images/home-loan/logo/axis-bank-logo.webp`} alt="logo" />
                            </div>
                        </div>
                    </div>
                </div>

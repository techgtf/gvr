                ...
                {data && (
                    data.map((item, index) => (
                        <div key={index} className="lg:px-[40px] lg:py-[30px] p-[18px] bg-white mb-4 rounded-[10px]">
                            ...
                            >
                                <span className="cursor-pointer lg:text-[14px] text-[13px] lg:tracking-[1px] capitalize">{item.question}</span>
                            ...
                            >
                                <div className="text-gray-700 pt-4 text-justify common_pera">{item.answer}</div>
                            </div>
                        </div>
                    ))
                )}

...
const data = [
  {
    ...
    date: "10-12-2024",
    title:
      "Buying vs Renting in Noida Sector 107: Which Option is Right for You?",
  ...
  },
  {
    ...
    date: "12-12-2024",
    title:
      "A Guide to the Best Schools, Hospitals, and Shopping Centers Near Sector 107, Noida",
          ...
          {blogs?.length > 0 ? (
            blogs.map((data, index) => (
              <div
                ...
                key={index}
              >
                <Link to={`${BASE_ROOT}blog/${data.slug}`} state={{ blog: data }}>
      ...
      <div className="lg:col-span-4">
        ...
        <ul>
          {latestBlog.length > 0 ? (
            ...
            <li key={index} className="text-gray-500 mt-5">
              No blogs found.
            </li>
          )}
        </ul>

        ...
        <div className='page_overview'>
            <div className='wrapper lg:max-w-[95%] lg:px-0 px-[15px] w-full m-auto lg:mb-[70px] mb-[20px]'>
                <SlideIn duration={2} delay={0.7}>
                    <p className='text-justify common_pera'>Did you know that tax benefits can be availed after the construction of the house as the interest repaid during construction cannot be claimed as Pre-EMI interest on the apartment loan? Read below for more about the various ways you can save tax on your apartment loan .</p>
                </SlideIn>
                <div className='grid_div lg:mt-[50px] grid lg:grid-cols-2 lg:gap-[50px] overflow-hidden'>
                    ...
                    <div className='contetn_div flex flex-col justify-center lg:gap-[55px] gap-[15px]'>
                        ...
                        <p className='text-justify common_pera'>Below are a few tips to help you catalog your deductions this year and may be utilized the same tips next year.</p>
                    </div>
                </div>
            </div>
        </div>
